              ...
              p-2 sm:p-[15px] flex items-center gap-20"
                    >
                        <motion.div
                            ...
                            initial="initial"
                            animate="animate"
                            className="flex-[0.967] h-[50px] rounded-[12px] border-[2px] border-[#E5E7EB] bg-[#F8FAFA] px-[14px] overflow-hidden relative"
                            style={{
                                background:
                        ...
                        >
                            ...
                            <div className="h-5 w-24 bg-white rounded opacity-70" />
                        </motion.div>
                    </motion.div>
                    <div className="grid px-5 py-6 w-full text-[16px] font-bold text-white bg-[#295C65] grid-cols-[minmax(120px,0.8fr)_minmax(150px,1.3fr)_minmax(200px,1.45fr)_minmax(100px,1fr)_minmax(100px,1fr)_120px_40px]">
                ...
                <div className="flex-1 min-h-0 orders-table-content">
                        {[...Array(7)].map((_, rowIndex) => (
                            <div
                                key={rowIndex}
                                className="flex-1 px-5 grid items-center py-6 grid-cols-[minmax(120px,0.8fr)_minmax(150px,1.3fr)_minmax(200px,1.45fr)_minmax(100px,1fr)_minmax(100px,1fr)_120px_40px] border-b border-[#E5E7EB] bg-white"
                            >
