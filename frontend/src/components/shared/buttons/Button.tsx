...
export const Button = ({
  ...
  const variantStyles = {
    primary: ` ${disabled ? "bg-[#1B626E]/60 text-white/60 cursor-wait": "bg-[#1B626E] text-white cursor-pointer hover:bg-[#297885] active:bg-[#145965]"} transition-all active:scale-[0.98] `,
