...
import { PriceInput } from "../../../shared/fields/PriceInput";
import { QuantityInput } from "../../../shared/fields/QuantityInput";
import { UnitSelector } from "../../../shared/fields/UnitSelector";
...
const EditProductForm = ({
    ...
    const validateField = (field: 'name' | 'note' | 'selectUnit', value: string) => {
        if (field === 'name') {
